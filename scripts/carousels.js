document.addEventListener("DOMContentLoaded", () => {
  document.addEventListener("cardsInPlace", () => {
    document
      .querySelectorAll(".home-page_subsection1")
      .forEach((subsection) => {
        ...
        mq1.addEventListener("change", () =>
          resetTrackPos(track, cards, leftButton, rightButton)
        );
      });
    ...
    function slideCard(
      ...
      if (targetSlide != null) currentSlide.style.opacity = "0.85";
    ...
    function buttonVisibilityToggle(
      ...
      if (currentSlide == cards[0]) leftButton.style.display = "none";
